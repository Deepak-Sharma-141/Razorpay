...
import com.deepakproject.razorpay.common.enums.SettlementStatus;
...
public class Settlement {
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amountsUnits", column = @Column(name = "gross_amount_units", nullable = false)),
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amountsUnits", column = @Column(name = "refund_amount_units", nullable = false)),
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amountsUnits", column = @Column(name = "fee_amount_units", nullable = false)),
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amountsUnits", column = @Column(name = "gst_amount_units", nullable = false)),
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amountsUnits", column = @Column(name = "net_amount_units", nullable = false)),
